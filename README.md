...
- **Lowest brackets are hit hardest.** The 32% floor is regressive in effect. At 2%, effective CGT jumps from 1% (Pre-Budget) to 16% (Post-Budget) -- a 15 percentage point increase, or 16× the former rate. At 18%, from 6% to 18% (3×). At 47%, from 24% to 45% (1.9×). The poorest investors face the largest proportional tax increase.
...
- **Fixed marginal rates during accumulation.** The model uses constant rates during the 10-year accumulation phase. In practice, a $100k portfolio at 9% p.a. generates only $6-8k of annual dividends and $1.5-3k of realised gains — insufficient to push any archetype into a higher bracket. Bracket creep becomes relevant only with larger portfolios or longer horizons.
